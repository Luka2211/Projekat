...
public partial class Admin : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("UnosiKorisnika.aspx");
    }
    ...
    {
        Response.Redirect("ResetujSifru.aspx");
    }

    protected void Button9_Click(object sender, EventArgs e)
    {
        Response.Redirect("PravoPristupa.aspx");
    }
    ...
    {
        Response.Redirect("IzbrisiKorisnika.aspx");
    }

    protected void Button6_Click(object sender, EventArgs e)
    {
        Response.Redirect("BrisiPreduzece.aspx");
    }
